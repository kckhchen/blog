...
![]({{ site.baseurl }}{% link assets/images/obsidian/venn.jpg %}){: width="500" }
...
![]({{ site.baseurl }}{% link assets/images/obsidian/venn-inner.jpg %}){: width="500" }
...
![]({{ site.baseurl }}{% link assets/images/obsidian/venn-left.jpg %}){: width="500" }
...
![]({{ site.baseurl }}{% link assets/images/obsidian/venn-full.jpg %}){: width="500" }
...
SQL 的 `JOIN` 系列就是這樣看了會懂，久了又會反覆忘記的知識，剛好這次讀出點心得，想透過淺顯易懂的解釋幫助有需要的人，也幫助未來再次忘記的自己。先感謝你把文章讀到這邊，如果你有興趣，我還寫了[關於 SELF JOIN 有趣應用的文章]({{ site.baseurl }}{% link _posts/2026-01-09-sql-self-join.md %})，歡迎過去看看。
