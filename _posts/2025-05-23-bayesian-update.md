...
[上一篇文章]({{ site.baseurl }}{% link _posts/2025-05-19-bayesian.md %})中我試著用直覺的方式介紹了貝氏統計的哲學：先驗機率以及機率更新。這篇文章將會深入數學的部分，介紹貝氏統計如何善用機率函數的特性以及鼎鼎大名的貝氏定理，從先驗機率和概似函數的計算中，用簡單的方法推算出後驗機率。 
